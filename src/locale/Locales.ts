...
const Locales: Record<LangKey, Locale> = {
  ...
  MAANEDSINNTEKT_HJELPELABEL_INFO: {
    ...
    en:
      '-## ' +
      '-- The time of calculation is January 29, 2021. This means that it is the income in the months of October, November, ' +
      'December 2020 that shall be used as a basis when making the calculation.\n' +
