...
const Languages: Record<Key, Locale> = {
  ...
  BULKINNSENDING_INFO: {
    nb:
      'Arbeidsgivere er pålagt å utbetale kompensasjon til ansatte *som _taper_ inntekt* fordi de ikke kan møte på arbeid som ' +
      'følge av _innreiseforbudet under pandemien._ Arbeidsgiveren forskutterer kompensasjonen og krever refusjon fra NAV.' +
      ...
      'for dager som den ansatte har hatt annen inntekt. Det _samme gjelder ytelser_ fra bostedslandet hvis arbeidsgiveren ' +
      'er kjent med det.\n' +
